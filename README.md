...
- **1,000 companies**, **9 sectors** (Technology, Energy, Transportation, Healthcare, Finance, Consumer Goods, Utilities, Retail, Manufacturing)
- **2015–2025**, ~11,000 company-year records, 16 columns
...
*(Note: this single-year, lag-feature holdout setup is not directly comparable to the multi-year LSTM evaluation below — see Results.)*
